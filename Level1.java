...
public class Level1 extends JPanel implements ActionListener{
        ...
        public void run(){
            while(true){
                try{                          
                    ...
                    if(charmage.walk == 1100 && charmage.checkfloor == 0&& Rogue.alive == false && Rogue2.alive == false){
                        checknextlevel = true;
                    }
    ...
    public void paintComponent(Graphics g){
        ...
        g.drawImage(door.getImage(), 1100, 550, 57, 84, this);
        //ballfire
        ...
        if(checknextlevel == true){
            ...
            g.drawString("SCORE   "+score,430,230);	     
            g.setFont(new Font("Tahoma",Font.HANGING_BASELINE,70));
            g.drawString("You Win Level 1!",340, 150);
            timer.stop();
            timercount.stop();
